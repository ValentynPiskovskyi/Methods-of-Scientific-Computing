...
### Update function
def update_gradient(x : np.ndarray, r : np.ndarray, b : np.ndarray, A : csr_array, verbose : bool = False) \
    -> np.ndarray:
    '''
...
### Gradient method
def gradient(A : csr_array, b : np.ndarray, tol : float, verbose : bool = False) \
